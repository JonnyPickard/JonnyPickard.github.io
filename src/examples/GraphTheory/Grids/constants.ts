...
// BG colors
export const BG_ALGORITH_CURRENT_TILE_COLOR = "bg-sky-600";
...
export const BG_PROCESSED_TILE_COLOR = "bg-teal-700";
export const BG_PLAYER_PATH_COLOR = "bg-lime-500";
export const BG_TERRAIN_COLOR = "bg-pink-700";
export const BG_PLAYER_START_COLOR = "bg-emerald-700";
export const BG_TARGET_COLOR = "bg-violet-700";
