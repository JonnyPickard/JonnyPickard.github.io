...
import * as AvatarStory from "../../examples/ReactThreeJs/Avatar/Avatar.stories";
...
npx gltfjsx src/assets/3DModels/Paladin.glb -t -r ./src/assets
```
...
I decided to put him in space using a cube camera/ texture to make a skybox. Because, why not 😂. 
