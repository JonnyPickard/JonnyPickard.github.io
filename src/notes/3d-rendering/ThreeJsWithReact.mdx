...
import * as SceneStories from "../../examples/react-threejs/AnimatedModel/AnimatedModel.stories";
...
npx gltfjsx src/assets/3DModels/UnrealSimpleMannequin.glb -t -r ./src/assets
```
...
As suggested, I tried using [Ready Player Me][7] to create a 3D avatar of myself using a photo, but honestly, I found the results lacking. There was a lack of hairstyles/ clothing that were relevant to me personally, so I ended up using an Unreal Engine mannequin instead.
...
<Canvas of={SceneStories.FlairAnimation} layout="centered" />
