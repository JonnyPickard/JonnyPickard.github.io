...
2. All <span className="text-emerald-500">edges</span> \(node to node connections or <span className="text-emerald-500">neighbours</span>\)
...
it is more important to create a function that finds all connections \(neighbours\) from
